...
ifeq ($(config),debug_win64)
  RESCOMP = windres
  TARGETDIR = bin/Debug
  TARGET = $(TARGETDIR)/PML.exe
  OBJDIR = obj/Win64/Debug
  DEFINES += -DPLATFORM_WINDOWS -D_CRT_SECURE_NO_WARNINGS -DDEBUG
  INCLUDES +=
  FORCE_INCLUDE +=
...
ifeq ($(config),release_win64)
  ...
  DEFINES += -DPLATFORM_WINDOWS -D_CRT_SECURE_NO_WARNINGS -DNDEBUG
  INCLUDES +=
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
